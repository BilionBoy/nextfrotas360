...
ActiveRecord::Schema[7.2].define(version: 2025_10_12_235224) do
  ...
  create_table "o_notas_fiscais", force: :cascade do |t|
    t.bigint "o_ordem_servico_id"
    t.string "numero"
    t.date "data_emissao"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["o_ordem_servico_id"], name: "index_o_notas_fiscais_on_o_ordem_servico_id"
    t.index ["o_status_nf_id"], name: "index_o_notas_fiscais_on_o_status_nf_id"
  end
  ...
  create_table "o_propostas_itens", force: :cascade do |t|
    t.bigint "o_proposta_id", null: false
    t.bigint "o_cotacao_item_id"
    t.decimal "quantidade", precision: 10, scale: 2, default: "0.0"
    t.decimal "valor_unitario", precision: 15, scale: 2, default: "0.0"
    t.decimal "total_item", precision: 15, scale: 2, default: "0.0"
    t.string "observacao"
    t.string "created_by"
    t.string "updated_by"
    t.datetime "deleted_at"
  ...
  create_table "o_status_nf", force: :cascade do |t|
    t.string "descricao"
    t.string "created_by"
    t.string "updated_by"
    t.datetime "deleted_at"
  ...
  add_foreign_key "o_notas_fiscais", "o_ordem_servicos"
  add_foreign_key "o_notas_fiscais", "o_status_nf"
